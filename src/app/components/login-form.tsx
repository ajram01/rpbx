...
import { createBrowserClient } from "@supabase/ssr"; // matches your SSR setup
...
export function LoginForm({
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Ensure RSCs re-render with the fresh session
    router.replace(next || "/dashboard");
    router.refresh();
  }

  // Optional: wire up OAuth (make sure your redirect URL is configured in Supabase)
